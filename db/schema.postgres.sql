...
-- ── market_breadth ─────────────────────────────────────────────
-- Daily market internals from our own stock_ohlcv universe (market_breadth.py).
-- date is TEXT to join cleanly against technical_signals.date / signal_outcomes.signal_date.
...
-- ── fundamentals_history (point-in-time snapshots, written by fundamentals_snapshot.py) ──
