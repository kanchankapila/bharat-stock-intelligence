...
conn.execute("DROP TABLE IF EXISTS trendlyne_screener_stocks_extracted")

# Create the extraction table - Use dialect-aware DDL
if use_postgres():
    conn.execute("""
...
print(f"Successfully extracted and inserted {total_inserted} stock rows into trendlyne_screener_stocks_extracted table!")
conn.close()
