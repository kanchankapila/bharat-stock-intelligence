...
export default function OptionsIntelligence() {
  const { data: pcrData, isLoading, error } = trpc.getOptionsIntelligence.useQuery(undefined, {
  ...
  if (!pcrData || pcrData.length === 0) {
    return <div className="text-gray-400 p-8 text-center">No options data available right now.</div>;
  }
