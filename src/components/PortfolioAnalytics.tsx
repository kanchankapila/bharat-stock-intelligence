  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-400 text-sm mt-1">Calculate risk metrics and correlation matrices for a custom portfolio.</p>
      </div>

      <Card className="p-6 bg-gray-900 border border-white/10">
        <div className="flex flex-col md:flex-row gap-4 items-end">
          <div className="flex-1">
            <label className="block text-sm font-medium text-gray-400 mb-2">Portfolio Symbols (comma-separated)</label>
            <input 
              type="text" 
              value={symbolsInput}
      ...
      {analyzeMutation.error && (
        <div className="p-4 bg-red-900/20 text-red-400 border border-red-500/20 rounded-lg">
      ...
      {analyzeMutation.data && !analyzeMutation.data.error && (
        <div className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <Card className="p-5 bg-gradient-to-br from-gray-800 to-gray-900 border border-white/5">
              ...
              <div className="text-xs text-gray-500 mt-1">Risk-adjusted return vs Nifty 50</div>
            </Card>
            ...
            <Card className="p-5 bg-gradient-to-br from-gray-800 to-gray-900 border border-white/5">
              ...
              <div className="text-xs text-gray-500 mt-1">Volatility relative to market</div>
            </Card>
            ...
            <Card className="p-5 bg-gradient-to-br from-gray-800 to-gray-900 border border-white/5">
              ...
              <div className="text-xs text-gray-500 mt-1">Expected yearly return</div>
            </Card>
            ...
            <Card className="p-5 bg-gradient-to-br from-gray-800 to-gray-900 border border-white/5">
              ...
              <div className="text-xs text-gray-500 mt-1">Max daily loss (95% confidence)</div>
            </Card>
          </div>

          <Card className="p-6 bg-gray-900 border border-white/5">
              ...
              <table className="w-full text-sm text-left text-gray-400">
                ...
                <tbody>
                  {Object.entries(analyzeMutation.data.correlation_matrix || {}).map(([rowSym, cols]: [string, any]) => (
                    <tr key={rowSym} className="border-b border-gray-800">
                      ...
                      {Object.keys(analyzeMutation.data.correlation_matrix || {}).map(colSym => {
                        ...
                        const isLow = val < 0.3;
                        return (
                          <td key={colSym} className={`px-6 py-4 font-mono ${isHigh ? 'text-red-400' : isLow ? 'text-green-400' : 'text-gray-400'}`}>
                            {val.toFixed(2)}
                          </td>
                        );
                      })}
